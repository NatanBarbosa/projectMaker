...
<section class="container py-3 mb-3" id="pagina-consulta">
        ...
        foreach ($lista_informacoes as $i => $li) {
            ...
            <div class="card col mb-2">
                <div class="card-header">
                    <h5 class="card-title text-center"> <?=$li->nome?> </h5>
                </div>
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">
                        ...
                        <small class="text-muted">Iniciado em <?= $arrDataInicio[2] . '/' . $arrDataInicio[1] . '/' . $arrDataInicio[0] ?> </small>
                    </p>
                </div>

                <div class="card-footer">
                    <button type="button" class="btn btn-secondary d-none esconder" id="esconder-projeto-<?= $li->id_projeto ?>" onclick="escondeProjeto(<?= $li->id_projeto ?>)"><i class="fas fa-eye-slash"></i><small>ocultar</small></button>
                    <button type="button" class="btn btn-success exibir" id="exibir-projeto-<?= $li->id_projeto ?>" onclick="exibeProjeto(<?= $li->id_projeto ?>)"><i class="fas fa-eye"></i> <small>exibir</small></button>
                    <button type="button" class="btn btn-danger" id="excluir-projeto-<?= $li->id_projeto ?>" onclick="excluiProjeto( <?= $li->id_projeto ?> , '<?= $li->nome ?>' )"> <i class="fas fa-trash"></i> <small>Excluir</small> </button>
                </div>
    ...
    foreach ($lista_informacoes as $i => $li) {
        ...
        <form method="post" action="logica/dados_criar_instancias.php?acao=atualizar" id="form-editar-<?=$li->id_projeto?>">
            ...
            <div id="projeto-<?=$li->id_projeto?>" class="border border-secondary p-3 mb-3 text-center projeto d-none">
                ...
                <div class="table-responsive" id="tabela-<?= $li->id_projeto ?>">
                ...
                <button type="button" class="btn btn-secondary mb-2" id="esconder-projeto-<?= $li->id_projeto ?>" onclick="escondeProjeto(<?= $li->id_projeto ?>)"><i class="fas fa-eye-slash"></i><small>ocultar</small></button>
                <button type="button" class="btn btn-danger mb-2" id="excluir-projeto-<?= $li->id_projeto ?>" onclick="excluiProjeto( <?= $li->id_projeto ?> , '<?= $li->nome ?>' )"> <i class="fas fa-trash"></i> <small>Excluir</small> </button>

                <br>

                <button type="button" class="btn btn-outline-warning" onclick="editionStart(<?= $li->id_projeto ?>)" id="editar-projeto-<?= $li->id_projeto ?>"><i class="fas fa-edit"></i> Editar projeto</button>
